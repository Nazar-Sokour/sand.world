/*
 * Dirent interface for the ROOT framework
 *
 * Created by Nazar Sokur
 * This file is a complete copy of dirent.h, originally created by
 * the author mentioned below, except for removal of the inclusion
 * of sys/types and sys/stat headers  to ensure compatibility with
 * CINT and CLING interpreters.
 * Compatible with ROOT version 6.26.02 and earlier
 */
...
// #include "sys/types.h"
// #include "sys/stat.h"
/* CINT and CLING on Windows have some issues with sys/types, sys/stat, corecrt headers */
#include <errno.h>
#include <ctype.h>
